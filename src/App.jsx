  ...
  return(<ErrorBoundary><AppProvider><AppContent/><ToastContainer/><ManualPaymentModal/>
    <style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;0,9..40,800;0,9..40,900&display=swap');
      *{margin:0;padding:0;box-sizing:border-box}
      :root{--cart-w:380px;--nav-w:72px;--pad:20px;--pad-sm:14px;--gap:14px;--gap-sm:10px;--radius:14px;--radius-sm:10px;--card-min:155px;--font-base:13px;--topbar-pad:12px 20px;--cart-pad:16px 20px 12px;--cart-item-pad:12px;--total-pad:16px;--btn-h:52px;--btn-font:14px}
      ...
      @media (max-width:1024px){:root{--cart-w:300px;--nav-w:60px;--pad:14px;--pad-sm:10px;--gap:10px;--gap-sm:6px;--radius:10px;--radius-sm:8px;--card-min:120px;--font-base:11px;--topbar-pad:8px 14px;--cart-pad:10px 14px 8px;--cart-item-pad:8px;--total-pad:10px;--btn-h:42px;--btn-font:12px}}`}</style>
