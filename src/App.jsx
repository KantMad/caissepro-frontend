  ...
  return(<ErrorBoundary><AppProvider><AppContent/><ToastContainer/><ManualPaymentModal/>
    <style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;0,9..40,800;0,9..40,900&display=swap');
      *{margin:0;padding:0;box-sizing:border-box}
      :root{--cart-w:380px;--nav-w:72px;--pad:16px;--pad-sm:12px;--gap:10px;--gap-sm:6px;--radius:14px;--radius-sm:10px;--card-min:155px;--font-base:13px;--topbar-pad:10px 16px;--cart-pad:14px 16px 10px;--cart-item-pad:10px;--total-pad:14px;--btn-h:52px;--btn-font:14px}
      ...
      @media (max-width:1366px){:root{--cart-w:340px;--pad:12px;--pad-sm:10px;--gap:8px;--gap-sm:5px;--card-min:140px;--font-base:12px;--topbar-pad:8px 12px;--cart-pad:10px 12px 8px;--cart-item-pad:8px;--total-pad:10px;--btn-h:46px;--btn-font:13px}}
      @media (max-width:1024px){:root{--cart-w:300px;--nav-w:60px;--pad:10px;--pad-sm:8px;--gap:6px;--gap-sm:4px;--radius:10px;--radius-sm:8px;--card-min:120px;--font-base:11px;--topbar-pad:6px 10px;--cart-pad:8px 10px 6px;--cart-item-pad:6px;--total-pad:8px;--btn-h:42px;--btn-font:12px}}`}</style>
