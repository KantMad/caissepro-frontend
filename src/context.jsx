...
function AppProvider({children}){
  ...
  const calcPromoDiscount=useCallback((cartItems)=>calcPromos(cartItems,activePromos,{pricingMode:settings.pricingMode,promoCode}),[activePromos,promoCode,settings.pricingMode]);
